...
The band "Parliament and Funkadelic" seems to have undergone a name change, resulting in no valid information being retrieved from Spotify. Overall, among artists with lower popularity, they span a wide range of musical genres with no specific, dominant genres found, reflecting a niche field. Among the artists who have high popularity, it was found that hip hop and various rock categories are relatively high. However, Spotify's segmentation of genes is relatively detailed, which makes it difficult to classify and analyze them well.
